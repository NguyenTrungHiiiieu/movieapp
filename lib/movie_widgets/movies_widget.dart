...
import 'package:movieappnew/screens/movie_details_screen.dart';
              ...
              child: GestureDetector(
                onTap: () {
                  if (movies[index].poster == null ||
                      movies[index].backDrop == null ||
                      movies[index].rating == null ||
                      movies[index].title == null ||
                      movies[index].overview == null) {
                    toastification.show(
                      context: context,
                      title: const Text('This Movie Has No Data!'),
